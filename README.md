...
3. **(Optional) Uncomment lines 19-27 in [pyproject.toml](./pyproject.toml) (shown in the following) if you have CUDA 12.4 on your system. This will install PyTorch with GPU support.
```sh
